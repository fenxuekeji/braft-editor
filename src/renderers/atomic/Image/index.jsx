    ...
    render() {
        ...
        return (
            <div className="braft-media-embeder">
                        ...
                        >
                                ...
                                <div onClick={this.preventDefault} className="braft-embed-image-link-editor">
                                    <div className="editor-input-group">
                                        <input type="text" placeholder={language.linkEditor.inputWithEnterPlaceHolder}
                                               ...
                                               defaultValue={link}/>
                                        <button type="button"
                                                onClick={this.confirmImageLink}>{language.base.confirm}</button>
                                    </div>
                            ...
                            {sizeEditorVisible ? (
                                <div onClick={this.preventDefault} className="braft-embed-image-size-editor">
                                    <div className="editor-input-group">
                                        <input type="text" placeholder={language.base.width}
                                               onKeyDown={this.handleSizeInputKeyDown} onChange={this.setImageWidth}
                                               defaultValue={width}/>
                                        <input type="text" placeholder={language.base.height}
                                               onKeyDown={this.handleSizeInputKeyDown} onChange={this.setImageHeight}
                                               defaultValue={height}/>
                                        <button type="button"
                                                onClick={this.confirmImageSize}>{language.base.confirm}</button>
                                    </div>
                                </div>
                            ) : null}
                            {imageControls.floatLeft ?
                                <a data-float="left" onClick={this.setImageFloat}>&#xe91e;</a> : null}
                            {imageControls.floatRight ?
                                <a data-float="right" onClick={this.setImageFloat}>&#xe914;</a> : null}
                            {imageControls.alignLeft ?
                                <a data-alignment="left" onClick={this.setImageAlignment}>&#xe027;</a> : null}
                            {imageControls.alignCenter ?
                                <a data-alignment="center" onClick={this.setImageAlignment}>&#xe028;</a> : null}
                            {imageControls.alignRight ?
                                <a data-alignment="right" onClick={this.setImageAlignment}>&#xe029;</a> : null}
                            {imageControls.size ? <a onClick={this.toggleSizeEditor}>&#xe3c2;</a> : null}
                            {imageControls.link ?
                                <a className={link ? 'active' : ''} onClick={this.toggleLinkEditor}>&#xe91a;</a> : null}
                ...
                {clearFix &&
                <div className="clearfix" style={{clear: 'both', height: 0, lineHeight: 0, float: 'none'}}></div>}
            </div>
        )
